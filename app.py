...
with col1:
    st.write("")  # Empty column on the left
...
with col1:
    ...
    st.markdown("""
    <ul>
        <li>Has demonstrated effective forecasting to prevent excess or shortage of materials, thereby ensuring
        cost efficiency in line with consumer demand.</li>
        <li>Developed an intuitive Google Data Studio dashboard
        for tracking raw material expiration, enabling all staff to align with the FIFO method for outgoing goods
        and swiftly identify and manage minimal stock levels accurately.</li>
    </ul>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    image = Image.open("images/univ2.png").resize((200, 200))
    st.image(image, caption="Universitas Pelita Bangsa", use_column_width=True)
